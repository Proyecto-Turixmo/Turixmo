...
import models.dao.HotelesModel;
import models.vo.Hoteles;
/**
 *
 * @author Neira Castillo
 */
@WebServlet(name = "HotelesController", urlPatterns = {"/hoteles"})
public class HotelesController {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action != null) {
            switch (action) {
                case "getall":
                    request.getRequestDispatcher("views/pages/hoteles/listaHoteles.jsp").forward(request, response); 
                    break;
                case "getbyid":
